    ...
    if(isset($_POST["submit"])){
        if(add_gacha($_POST) > 0){
            ...
            <script>
                ...
                document.location.href = 'add_gacha.php';
            </script>
            ";
        }
    }
        ...
        <div class="container">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="mb-3 pt-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="Banner" name="banner" required>
                    </div>
                </div>
                <div class="mb-3 pt-3 row">
                ...
                <button type="submit" name="submit" class="btn btn-primary mb-3">Add Gacha</button>
